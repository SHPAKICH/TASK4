fun main() {
    println("Эта программа - калькулятор с двумя числами, вы можете ввести данные через одинарный пробел, в формате \"число1 число2 операция\" и получить результат.\n")
    while (true) {
